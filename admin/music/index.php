...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid card py-0">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td><img 
                                    src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['music_thumbnail']); ?>" 
                            ...
                            <td class="text-nowrap">
                                ...
                                <i 
                                    class="mdi mdi-delete text-danger fst-normal" 
                                    role="button" 
                                    data-bs-toggle="modal" 
                                    data-bs-target="#exampleModal<?php echo $row['music_id'] ?>"
                                >Delete
                                </i>
                            </td>
                        </tr>
